        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatformDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PlatformServices = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierAreas", x => new { x.SupplierId, x.AreaId });
                    table.ForeignKey(
                        name: "FK_SupplierAreas_Areas_AreaId",
                        column: x => x.AreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplierAreas_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advertisements_IsActive_StartDate_EndDate",
