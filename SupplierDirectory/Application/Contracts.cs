...
public sealed class CategoryRequest { [Required(ErrorMessage="اسم التصنيف مطلوب")] public string Name {get;set;}=""; public string? Description {get;set;} public int? ParentCategoryId {get;set;} public bool IsActive {get;set;}=true; }
public sealed class ProductCategoryRequest { [Required(ErrorMessage="اسم تصنيف المنتج مطلوب")] public string Name {get;set;}=""; public string? Description {get;set;} public int? ParentCategoryId {get;set;} public bool IsActive {get;set;}=true; }
...
public sealed record AreaDto(int Id, string Name, string? Description, int? ParentAreaId, string? ParentAreaName = null);

public sealed record CategoryDto(int Id, string Name, string? Description, string? ImageUrl, int? ParentCategoryId, string? ParentCategoryName = null, int? SubCategoriesCount = null);

public sealed record ProductCategoryDto(int Id, string Name, string? Description, string? ImageUrl, int? ParentCategoryId, string? ParentCategoryName = null, int? SubCategoriesCount = null);

public sealed class ServiceRequest { [Required(ErrorMessage="اسم الخدمة مطلوب")] public string Name {get;set;}=""; public string? Description {get;set;} public string? Details {get;set;} public int DisplayOrder {get;set;} public bool IsActive {get;set;}=true; }

public sealed record ProductDto(int Id, string Name, string? Description, string? Details, int? AreaId, string? AreaName, int? ProductCategoryId, string? ProductCategoryName, IEnumerable<object> Images);

public sealed record ServiceDto(int Id, string Name, string? Description, string? Details, int DisplayOrder, IEnumerable<object> Images);
