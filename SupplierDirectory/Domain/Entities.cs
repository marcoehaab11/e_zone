...
public sealed class CompanyInfo : AuditableEntity { public string? CompanyName { get; set; } public string? LogoUrl { get; set; } public string? CoverImageUrl { get; set; } public string? About { get; set; } public string? Mission { get; set; } public string? Vision { get; set; } public string? PlatformDescription { get; set; } public string? PlatformServices { get; set; } public string? ContactPhone { get; set; } public string? WhatsApp { get; set; } public string? Email { get; set; } public string? Website { get; set; } public string? SocialLinksJson { get; set; } public ICollection<CompanyImage> Images { get; set; } = []; public ICollection<CompanyLink> Links { get; set; } = []; }
