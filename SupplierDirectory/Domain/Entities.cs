...
public sealed class SupplierArea { public int SupplierId { get; set; } public Supplier Supplier { get; set; } = null!; public int AreaId { get; set; } public Area Area { get; set; } = null!; }
public sealed class Advertisement : AuditableEntity { public required string Title { get; set; } public string? Description { get; set; } public string? ImageUrl { get; set; } public string? Link { get; set; } public DateTime? StartDate { get; set; } public DateTime? EndDate { get; set; } public bool IsActive { get; set; } = true; public int DisplayOrder { get; set; } public int? AreaId { get; set; } public Area? Area { get; set; } }
public sealed class CompanyInfo : AuditableEntity { public string? CompanyName { get; set; } public string? LogoUrl { get; set; } public string? CoverImageUrl { get; set; } public string? About { get; set; } public string? Mission { get; set; } public string? Vision { get; set; } public string? PlatformDescription { get; set; } public string? PlatformServices { get; set; } public string? ContactPhone { get; set; } public string? WhatsApp { get; set; } public string? Email { get; set; } public string? Website { get; set; } public string? SocialLinksJson { get; set; } public ICollection<CompanyCoverImage> CoverImages { get; set; } = []; public ICollection<CompanyImage> Images { get; set; } = []; public ICollection<CompanyLink> Links { get; set; } = []; }
public sealed class CompanyCoverImage : AuditableEntity { public int CompanyInfoId { get; set; } public CompanyInfo CompanyInfo { get; set; } = null!; public required string ImageUrl { get; set; } public int DisplayOrder { get; set; } }
public sealed class CompanyImage : AuditableEntity { public int CompanyInfoId { get; set; } public CompanyInfo CompanyInfo { get; set; } = null!; public required string ImageUrl { get; set; } public int DisplayOrder { get; set; } }
public sealed class CompanyLink : AuditableEntity { public int CompanyInfoId { get; set; } public CompanyInfo CompanyInfo { get; set; } = null!; public required string Title { get; set; } public required string Url { get; set; } public int DisplayOrder { get; set; } }
